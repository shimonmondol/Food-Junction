...
const Choose = () => {
  return (
    <div className="bg-[#F5F5F5] w-full">
      <div className="w-[1000px] mx-auto pt-20 justify-between px-2">
        <div className="flex justify-between">
          <div className="w-[500px]">
            <h1 className="font-poppins font-bold text-3xl text-[#585858]">
              WHY CHOOSE US <br />{" "}
              <span className="text-[#FB9333] mt-2 block">
        ...
        <div className="flex justify-between">
          <div class="box-content bg-white w-48 h-64 p-4 border-2 border-orange-50 rounded-2xl mt-12">
